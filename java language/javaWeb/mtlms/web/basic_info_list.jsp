...
<div class="page-content clearfix">
    <div class="sort_style">
        ...
        <span class="l_f">
        <a href="javascript:ovid()" id="sort_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加评估类目</a>
    ...
    <div class="">
        ...
        <ul>
            <li>
                ...
                <div class="col-sm-9">
                    <input name="basicInfoName" title="类目名称" type="text" id="form-field-1" placeholder="请输入新的类目名称" class="col-xs-10 col-sm-5" style="width: 500px;">
                </div>
            </li>
        </ul>
        </form>
