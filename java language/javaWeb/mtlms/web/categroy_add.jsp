   ...
   <div class="type_title">添加分类</div>
	...
	<form action="CategoryAddServlet" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		...
		<div class=" clearfix cl"  style="margin-top: 30px;">
		 ...
		 <div class="formControls col-10"><input type="text" class="input-text" style="height: 35px;"  value="" placeholder="" name="categoryName"></div>
		</div>
		
		<div class=" clearfix cl" style="margin-top: 30px;">
		 <label class="form-label col-2">分类图片：</label>
		 <div class="formControls col-10"><input type="file" class="input-text" style="height: 35px;"  value="" placeholder="" name="categoryIcon"></div>
		</div>
		
		<div class="clearfix cl" style="margin-top: 30px;">
			<div class="Button_operation">
				<button class="btn btn-primary radius" type="submit">提交保存</button>
				<a href="CategoryListServlet" class="btn btn-warning radius" type="button">&nbsp;&nbsp;取消&nbsp;&nbsp;</a>
			</div>
		</div>
	</form>
	</div>
