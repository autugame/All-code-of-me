...
<%--                </li>--%>
                <li class=" clearfix">
                    ...
                    <input name="brandId" type="hidden" value="${brand.brandId}" class="add_text" style="width:600px"/>${brand.brandId}
                </li>
                <li class=" clearfix">
                    <label class="label_name"><i>*</i>品牌名称：</label>
                    <input name="brandName" type="text" class="add_text" value="${brand.brandName}" style="width:600px"/>
                </li>
                <li class=" clearfix">
                    <label class="label_name"><i>*</i>品牌图片：</label>
                    <img id="reviewImg" src="${brand.brandLogo}" height="80"/><input type="hidden" value="${brand.brandLogo}" name="brandLogoPath" id="brandLogoPath"/>
                ...
                <li class=" clearfix">
                    ...
                    <c:if test="${brand.brandStatus == 0}">
                        ...
                        <label><input type="radio" value="0" class="ace" name="brandStatus" checked="checked"><span class="lbl">不显示</span></label>
                    </c:if>
                </li>
            </ul>
        </div>
