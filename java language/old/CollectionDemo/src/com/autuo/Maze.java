...
public class Maze extends JPanel {
  ...
  private void checkIsWin() {
    if (ballX == NUM - 1 && ballY == NUM - 1) {
      JOptionPane.showMessageDialog(null, "在这里恭喜你通关了 !", "你成功走出了迷宫",
  ...
  public static void main(String[] args) {
	    ...
	    JFrame frame = new JFrame("MAZE(按粉丝要求简单的游戏)");
	    ...
	    PlaySound();
	    JOptionPane.showMessageDialog(null, "按空格键显示或隐藏路径", "新手指导", JOptionPane.PLAIN_MESSAGE);
  }
  ...
  private static void PlaySound() {
	  try {
		...
		InputStream is = Maze.class.getClassLoader().getResourceAsStream("sound/music.wav");
